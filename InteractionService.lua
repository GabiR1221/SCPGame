...
function S.new(states:any,noise:any,remote:RemoteEvent):any return setmetatable({States=states,Noise=noise,Remote=remote,Rooms={} :: {[number]:boolean},Active={},Reserved={},Cooldowns={},Buckets={},Handlers={}},S) end
...
function S._request(self:any,player:Player,targetValue:any,requested:any)
...
function S.Start(self:any,request:RemoteEvent)
	request.OnServerEvent:Connect(function(player,target,id) self:_request(player,target,id) end)
