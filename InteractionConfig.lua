...
return table.freeze({
	...
	Definitions=table.freeze({
		OpenDrawer={AnimationKey="OpenDrawer",Duration=1.2,CommitTime=.05,Locks={"Movement","Jump","Interaction","Rotation"},NoiseRadius=22},
		CloseDrawer={AnimationKey="CloseDrawer",Duration=1.2,CommitTime=.05,Locks={"Movement","Jump","Interaction","Rotation"},NoiseRadius=12},
		Locker={AnimationKey="LockerEnter",Duration=.7,CommitTime=.05,Locks={"Interaction"},NoiseRadius=8,UseTargetCamera=false},
