...
folder(ServerStorage,"EntityTemplates")
folder(ServerStorage,"PowerTemplates")
...
local upgradePurchaseRequest=remote("UpgradePurchaseRequest")
local upgradeStateChanged=remote("UpgradeStateChanged")
local combatRequest=remote("CombatRequest")
local combatStateChanged=remote("CombatStateChanged")
...
local UpgradeService:any=require(Services:WaitForChild("UpgradeService")).new(upgradePurchaseRequest,upgradeStateChanged); UpgradeService:Start()
local CreatureService:any=require(Services:WaitForChild("CreatureService")).new(Lifecycle,Tracker,RunManager); CreatureService:Start()
local CombatService:any=require(Services:WaitForChild("CombatService")).new(PlayerStateService,UpgradeService,CreatureService,combatRequest,combatStateChanged); CombatService:Start()
