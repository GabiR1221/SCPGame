...
return table.freeze({
	...
	FirstPersonBody = table.freeze({ForwardOffset=.28,DownwardForwardBonus=.24,ForwardSign=-1,AlignCharacterYaw=true}),
	LookBend = table.freeze({Enabled=true, MaximumPitch=math.rad(55), WaistWeight=.65, NeckWeight=.35, SmoothSpeed=14}),
	Debug = false,
})
